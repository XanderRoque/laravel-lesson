<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div class="col-12">
            ...
            <x-text-input id="update_password_current_password" name="current_password" type="password" class="form-control w-25" autocomplete="current-password" />
        ...
        <div class="col-12">
            ...
            <x-text-input id="update_password_password" name="password" type="password" class="form-control w-25" autocomplete="new-password" />
        ...
        <div class="col-12">
            ...
            <x-text-input id="update_password_password_confirmation" name="password_confirmation" type="password" class="form-control w-25" autocomplete="new-password" />
